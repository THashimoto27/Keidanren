...
function main(){
  ...
  var filePath = 'https://thashimoto27.github.io/Keidanren/graph3/stock_data.csv';
       ...
       var ctx = document.getElementById('myChart').getContext('2d');
        ...
        data: {
            ...
            datasets: [{
                label: tmpLabel,
                data: tmpData, //データ
                borderColor: 'rgba(120,182,255,1)', //線の色
                backgroundColor: 'rgba(120,182,255,1)',
...
function graphupdate(chart,checkcount_i){
        // グラフ追加色
        console.log(checkcount_i)
        console.log(checkcount)
        var bcolor
        if(checkcount_i==0){
            bcolor= 'rgba(120,182,255,1)'
        }else if(checkcount_i==1){
            bcolor= 'rgba(100,150,120,1)'
        }else{
            bcolor= 'rgba(250,50,5,1)'
        }
        //データの追加
